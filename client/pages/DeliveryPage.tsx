...
const deliveryOrders: DeliveryOrder[] = [
  ...
  },
  {
    ...
    products: [{ name: "Corn Seed Standard", quantity: 560, unit: "bags" }],
    status: "delivered",
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">
              Track and manage seed product deliveries
            </p>
          </div>
                      ...
                      <td className="py-3 px-4">
                        {order.trackingNumber ? (
                          <div className="text-sm">
                            <div className="font-mono text-brand-600">
                              {order.trackingNumber}
                            </div>
                            {order.driver && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      <strong>Email:</strong>{" "}
                      {selectedOrder.customerContact.email}
                    </div>
                    <div>
                      <strong>Address:</strong>{" "}
                      {selectedOrder.customerContact.address}
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      ...
                      {selectedOrder.driver || "Not assigned"}
                    </div>
                    <div>
                      <strong>Truck:</strong>{" "}
                      {selectedOrder.truck || "Not assigned"}
                    </div>
                    <div>
