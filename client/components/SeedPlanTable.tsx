              ...
              <tr key={customer.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right">
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      handleEditStart(customer.id, customer.currentYearUnits)
                    }
          ...
          <div className="flex space-x-4">
            <span>
              ...
              <span className="font-medium text-gray-900">
                {customers
                  .reduce((sum, c) => sum + c.currentYearUnits, 0)
                  .toLocaleString()}
              </span>
            </span>
            <span>
              ...
              <span className="font-medium text-gray-900">
                {customers
                  .reduce((sum, c) => sum + c.previousYearUnits, 0)
                  .toLocaleString()}
              </span>
            </span>
          </div>
